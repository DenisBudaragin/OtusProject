...
public class CourseFinder extends WebDriverManager {
    ...
    public void testCourseFinder() {
        findCourseByName("//h6/div[contains(text(), 'SRE практики и инструменты')]", CATALOG_URL, COURSE_NAME);
    ...
    public void findCourseByName(String courseXpath, String url, String courseName) {
        ...
        WebElement targetCourse = courseElements.stream()
                .filter(element -> {
                    String elementText = element.findElement(By.xpath(courseXpath)).getText();
