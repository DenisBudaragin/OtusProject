...
//
//public class TeachersFindAndOpenPopUpTest {
//    TeachersFindAndOpenPopUpTest test = DependencyInitializer.getInstance(TeachersFindAndOpenPopUpTest.class);
...
//
//    @Inject
//    public TeachersFindAndOpenPopUpTest(Page page, TestConfig config) {
//        this.page = page;
//        this.config = config;
