...
//    public static final String CATALOG_URL = "https://otus.ru/catalog/courses";
    ...
    public static final String COURSE_NAME = "C# Developer. Basic"; // Замените на имя курса для поиска
    public static final String COURSE_XPATH = "//h6/div[contains(text(), 'C# Developer. Basic')]"; // Замените на имя курса для поиска
