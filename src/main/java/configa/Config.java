...
//    public static final String CATALOG_URL = "https://otus.ru/catalog/courses";
    ...
    public static final String COURSE_NAME = "DevOps Advanced"; // Замените на имя курса для поиска
    public static final String COURSE_XPATH = "//h6/div[contains(text(), 'DevOps Advanced')]"; // Замените на имя курса для поиска
