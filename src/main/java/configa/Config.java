...
//    public static final String CATALOG_URL = "https://otus.ru/catalog/courses";
    ...
    public static final String COURSE_NAME = "Solidity Developer"; // Замените на имя курса для поиска
    public static final String COURSE_XPATH = "//h6/div[contains(text(), 'Solidity Developer')]"; // Замените на имя курса для поиска
